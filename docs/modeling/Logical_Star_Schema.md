...
\- The star schema is centered on a single, line-level sales fact to

&nbsp; maximize analytical flexibility.

\- Sales order header data is treated as a supporting source and is

&nbsp; integrated into the fact table where analytically relevant.

\- Physical design considerations such as surrogate keys, indexing,

&nbsp; partitioning, and slowly changing dimensions are intentionally

&nbsp; excluded from this document and will be addressed in later phases.
